...
Computer Engineering at the University of Virginia (GPA 4.0, expected 2028), focused on embedded software and firmware. The work is real-time drivers, hardware bring-up, and validation on real hardware. I like short build-and-test loops, working firmware in days, not months.
